package bitcoin.app.com.coinsafe.HowIItWorks;
...
public class How_It_Works extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                R.layout.work1_fragment,
                R.layout.work2_fragment,
                R.layout.work3_fragment,
                R.layout.work4_fragment};
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(How_It_Works.this, Login_Signup_tabbed.class));
        finish();
    }
